      ...
      <div className="max-width pt-6">
        ...
        <div className="mb-8 flex flex-col gap-3">
          <Link
            ...
            className="flex items-center justify-center gap-2 rounded-md bg-white px-4 py-3 text-base font-medium text-dark shadow-sm transition-all hover:bg-gray-50"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-md bg-primary px-4 py-3 text-base font-medium text-white shadow-sm transition-all hover:bg-primary/90"
          >
            {isGeneratingEmail ? (
